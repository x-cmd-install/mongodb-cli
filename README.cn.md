...
![mongodb-cli](https://repo.x-cmd.io/mongodb-cli.svg?lang=zh)
...
- **上游仓库**: <https://github.com/mongodb/mongodb-cli>
- **许可证**: Apache-2.0

## 发布

- **最新版本**: `mongocli/v2.0.7` (2026-01-08)
- **最近提交**: 2026-09-08
- **Release 含资产**: 18 个

## 流行度

- **Star**: 8 · **Fork**: 7 · **开放 issue**: 2 · **贡献者**: 43

## 累计统计

- **发布数**: 9 · **已合并 PR**: 100 · **开放 PR**: 1 · **已关闭 issue**: 2 · **开放 issue**: 0 · **提交数**: 2826

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-12 | 0 | 13 | 1 | 0 | 0 | 13 |
| last60d | 2026-07-13 | 0 | 19 | 1 | 0 | 0 | 19 |
| 90d | 2026-06-13 | 0 | 24 | 1 | 0 | 0 | 24 |
| last180d | 2026-03-15 | 0 | 36 | 1 | 0 | 0 | 36 |
| 360d | 2025-09-16 | 2 | 59 | 1 | 1 | 0 | 60 |
| last720d | 2024-09-21 | 9 | 100 | 1 | 2 | 0 | 126 |
...
在 [repology.org](https://repology.org/project/mongodb-cli) 上共有 **12** 个发行版报告此项目。**7** 个 ✅ 已是最新上游版本，**3** 个 ⚠️ 使用旧版本。
...
mongodb-cli 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `mongodb-cli` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/mongodb-cli.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260911.yml` · 2026-09-11T04:24:22Z._
